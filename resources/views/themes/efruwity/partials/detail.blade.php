            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
						...
						<div class="tab-pane" id="pro-details{{ $i}}" role="tabpanel">
						    <img src="{{ asset('storage/'.$image->path) }}" alt="{{ $produk->product_id }}" img class="w-100">
                        </div>
                        @php
							$i++
						@endphp
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <p class="available-stock">Stok Produk: {{ $produk->StokProduk }}<p>
						...
						<ul>
							<li>
								<div class="form-group quantity-box">
									...
									<label class="control-label">Quantity (kilograms)</label>

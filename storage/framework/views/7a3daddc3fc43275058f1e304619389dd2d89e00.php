<aside class="left-sidebar bg-sidebar">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#app"
                      ...
                      <span class="nav-text">Manajemen Order</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="app"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="<?php echo e(url('admin/processing')); ?>">
        ...
        </aside><?php /**PATH C:\xampp\htdocs\E-Fruwity\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>